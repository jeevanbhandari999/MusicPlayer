...
class AppTheme {
  ...
  static final Color _lightCircleAvatar = Colors.grey;
  ...
  static final Color _darkCircleAvatar = Colors.grey;
  ...
  static ThemeData lightMode = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      primaryContainer: _lightCircleAvatar,
    ),
  ...
  static ThemeData darkMode = ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      ...
      primaryContainer: _darkCircleAvatar,
    ),
    appBarTheme: AppBarTheme(
